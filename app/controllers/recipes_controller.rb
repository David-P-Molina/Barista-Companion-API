class RecipesController < ApplicationController
  ...
  # GET /recipes/1
  def show
    render json: @recipe.slice(:id, :name, :date_attempted, :brew_method_id, :brew_method_name, :coffee_bean_id, :coffee_bean_name, :roaster_name, :roast_date, :grind, :coffee_in_grams, :water_in_grams, :temperature, :filter, :time, :bloom_time, :notes, :deletable)
  end
